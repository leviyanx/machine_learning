...
% refer to other's answer; but why the given hypothesis from document is wrong?
% the factor after being corrected: the sum of square of theta_j doesn't contain the theta(1)
